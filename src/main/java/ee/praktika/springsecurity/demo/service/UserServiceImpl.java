...
import ee.praktika.springsecurity.demo.dao.RoleDao;
import ee.praktika.springsecurity.demo.dao.UserDao;
...
public class UserServiceImpl implements UserService {
    ...
    public void save( CrmUser crmUser ){
        ...
        user.setRoles( Arrays.asList( roleDao.findRoleByName( "ROLE_CREATURE" ) ) );
